...
export class Transform
{
	...
	updateModelTransformMatrix(m)
	{
		...
		{
			// mat4.identity(this.modelTransformMatrix);
			// // console.log(this.modelTransformMatrix,this.translate);
			...
			// mat4.translate(this.modelTransformMatrix, this.modelTransformMatrix, this.translate);
			// TODO try saved matrix
			// angles given that are given initially are w.r.t. the origin now it is diffenent
